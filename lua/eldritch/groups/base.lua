...
function M.get(c, opts)
  ...
  return {
    ...
    DiffText                    = { fg = c.fg, bg = c.magenta3 }, -- diff mode: Changed text within a changed line |diff.txt|
    ...
    LineNr                      = { fg = c.fg_gutter_light or c.fg_gutter }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    CursorLineNr                = { fg = c.green, bold = true }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
    ...
    PmenuMatch                  = { bg = c.bg_popup, fg = c.cyan }, -- Popup menu: Matched text in normal item.
    PmenuSel                    = { bg = Util.blend_bg(c.fg_gutter, 0.8) }, -- Popup menu: selected item.
    PmenuMatchSel               = { bg = Util.blend_bg(c.fg_gutter, 0.8), fg = c.cyan }, -- Popup menu: Matched text in selected item.
    ...
    LspInlayHint                = { bg = Util.blend_bg(c.cyan, 0.1), fg = c.dark3 },
